<?php
/**
 * Template Name: Lumen: Entrada ancho completo
 * Template Post Type: post
 *
 * Keeps the complete single-post editorial structure while forcing Lumen's
 * full reading canvas and disabling the sidebar for this post only.
 *
...
get_header();
?>
<main id="cw-main-content" class="cw-template-main"><div class="cw-content-wrap cw-entry cw-entry--single cw-single-layout--full cw-single-header-align--<?php echo esc_attr( $creceweb_header_alignment ); ?> cw-screen-layout cw-screen-layout--none">
